...
// my_edit		
		...
		while(!failed && !GCamera.Abort)
		{
			...
			while((errCode = PvCaptureWaitForFrameDone(GCamera.Handle,&GCamera.Frames[Index],20000)) == ePvErrTimeout)
			{
...
//QImage convertToFormat(QImage::Format_RGB888, Qt::ImageConversionFlags flags = Qt::AutoColor) const Q_REQUIRED_RESULT;
