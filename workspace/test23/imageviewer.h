...
PvAttrUint32Set(GCamera.Handle,"Height",820);

PvAttrUint32Set(GCamera.Handle,"Width",820);
...
PvAttrUint32Set(GCamera.Handle,"Width",800);
// my_edit

		// set the camera to 5 FPS, continuous mode, and start camera receiving triggers					
		if((PvAttrFloat32Set(GCamera.Handle,"FrameRate",20) != ePvErrSuccess) ||
...
qDebug() << "   _reserved2[32]; " << GCamera.Frames[Index]._reserved2[32];
	...
	/*	QImage image((unsigned char*)GCamera.Frames[Index].ImageBuffer,800,800,800*3,QImage::Format_RGB888);
