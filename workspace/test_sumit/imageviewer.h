...
//if((errCode = PvAttrUint32Set(GCamera.Handle, "PacketSize",8228)) != ePvErrSuccess)
		{
...
// my_edit
		...
		if((PvAttrFloat32Set(GCamera.Handle,"FrameRate",4) != ePvErrSuccess) ||
...
qDebug() <<"FrmCmp : "<<FrameCompleted << " FrmDrp :" <<FrameDropped << " PckCmp :" <<PacketReceived << " PckMss :" <<PacketMissed << " FrmRt :" <<FrameRate << " imageSize :" <<imageSize;
		...
		//QImage image((unsigned char*)GCamera.Frames[Index].ImageBuffer, 1360,1024,QImage::Format_RGB888);


		image.loadFromData((unsigned char*)GCamera.Frames[Index].ImageBuffer,QImage::Format_RGB888);	
