...
//   }
    ...
    QImage image((unsigned char*)GCamera.Frames[Index].ImageBuffer,1360,1024,QImage::Format_Indexed8);



QVector<QRgb> colorTable(1024);
...
QImage image2 = new QImage(GCamera.Frames[0].Width,GCamera.Frames[0].Height,QImage::Format_RGB888);
...
//   QVector<QRgb> image.colorTable () const
...
//		QImage image((unsigned char*)GCamera.Frames[Index].ImageBuffer, 1360,1024,1360,QImage::Format_Indexed8);
   ...
   //     image = image.convertToFormat(QImage::Format_RGB888,Qt::ColorOnly);
		...
		buffer = QPixmap::fromImage(image2);
